# Prisma Cloud Azure Subscription Onboarding Terraform Template Sample
## Overview
This is an example of a Terraform template generated from Prisma Cloud to onboard an Azure Subscription. The following items have been enabled as part of this onboarding:
...
* Assigns necessary roles to the service principal at the subscription and resource group scopes.
* Creates resource group as needed for agentless scanning.
...
## Other References
To onboard an Azure Subscription manually without using Terraform script, refer to the techdoc [here](https://docs.prismacloud.io/en/enterprise-edition/content-collections/connect/connect-cloud-accounts/onboard-your-azure-account/connect-azure-account).

## Conclusion
This is just a sample Terraform script to onboard Azure Subscription. For actual Terraform script, please generate the updated script from Prisma Cloud.